...
UKpostcodes <- readShapeSpatial("shapefiles/GB_Postcodes/PostalArea.shp")
#Verify it loaded correctly
plot(UKpostcodes)

#Plot the shapes using ggplot2
UKpostcodes <- fortify(UKpostcodes, region = "PostArea")
...
map + geom_point(data = hospitals, mapping = aes(x = lon, y = lat,fill = NULL,group = NULL), size = 1)
```
